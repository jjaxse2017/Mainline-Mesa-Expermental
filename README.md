...
Goto the release page for the compile instructions/files at https://github.com/jjaxse2017/Mainline-Mesa-Expermental/releases and download the latest release. A bonus Mesa 18.0-dev used to benchmark the winning amd drivers are linked to the release, anyone with other cards, I'd be happy to know about your results.
