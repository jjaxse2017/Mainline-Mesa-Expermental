...
--One mainline mesa experimental open source radeon gpu out performs 58% better than two windows 10 crossfire radeon gpu's
...
Goto the release page for the compile instructions/files https://github.com/jjaxse2017/Mainline-Mesa-Expermental/releases. As an added bonus Mesa 13.0-dev with amd drivers is linked to the release for the lazy people out there. 
